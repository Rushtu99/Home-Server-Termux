...
MEDIA_VAULT_ROOT="${MEDIA_VAULT_ROOT:-${DRIVES_D_DIR:-$USER_HOME/Drives/D}/$MEDIA_VAULT_DIR_NAME/$MEDIA_VAULT_MEDIA_SUBDIR}"
MEDIA_SCRATCH_ROOT="${MEDIA_SCRATCH_ROOT:-${DRIVES_E_DIR:-$USER_HOME/Drives/E}/$MEDIA_SCRATCH_DIR_NAME/$MEDIA_SCRATCH_MEDIA_SUBDIR}"
