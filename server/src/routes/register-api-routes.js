const registerApiRoutes = ({ registerDualRoute, middleware, handlers, rawUploadParser }) => {
  ...
  registerDualRoute('get', '/services/status', requireAuth, requireAdmin, workflowStateServicesHandler);
  ...
  registerDualRoute('post', '/clusters/start/:name', requireAuth, requireAdmin, clusterActionHandler);
  registerDualRoute('post', '/clusters/stop/:name', requireAuth, requireAdmin, clusterActionHandler);
  registerDualRoute('post', '/clusters/restart/:name', requireAuth, requireAdmin, clusterActionHandler);
  ...
  registerDualRoute('post', '/services/start/:name', requireAuth, requireAdmin, serviceActionHandler);
  registerDualRoute('post', '/services/stop/:name', requireAuth, requireAdmin, serviceActionHandler);
  registerDualRoute('post', '/services/restart/:name', requireAuth, requireAdmin, serviceActionHandler);
